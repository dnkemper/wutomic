...
$config = [
    ...
    'default-sp' => [
        ...
        'entityID' => 'https://artsciprod.wustl.edu-prod/',
...
if (getenv('PANTHEON_ENVIRONMENT') == 'dev') {
    $config['default-sp']['entityID'] = 'https://artscidev.wustl.edu/';
    $config['default-sp']['idp'] = 'https://login.wustl.edu/idp/shibboleth';
    $config['default-sp']['privatekey'] = 'saml-dev.pem';
    $config['default-sp']['certificate'] = 'saml-dev.crt';
}
if (getenv('PANTHEON_ENVIRONMENT') == 'test') {
    $config['default-sp']['entityID'] = 'https://artscistage.wustl.edu-staging/';
    $config['default-sp']['idp'] = 'https://login.wustl.edu/idp/shibboleth';
    $config['default-sp']['privatekey'] = 'saml-stg.pem';
    $config['default-sp']['certificate'] = 'saml-stg.crt';
}
if (getenv('PANTHEON_ENVIRONMENT') == 'live') {
    $config['default-sp']['entityID'] = 'https://artsciprod.wustl.edu-prod/';
    $config['default-sp']['idp'] = 'https://login.wustl.edu/idp/shibboleth';
