...
$config = [
    ...
    'store.sql.dsn'                 => 'mysql:host=artsciprod-d9.cwqu12tw5vjb.us-east-1.rds.amazonaws.com;dbname=drupal_prehealth',
    /*
     * The username and password to use when connecting to the database.
     */
    'store.sql.username' => 'drupal_db_user',
    'store.sql.password' => 'j^AV2D3wou#<784',
