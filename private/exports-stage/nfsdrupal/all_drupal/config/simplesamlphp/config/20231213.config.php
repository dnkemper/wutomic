...
$config = [
     ...
     * reverse proxy).
     */
    'baseurlpath' => 'https://movingstories.artscistage.wustl.edu/simplesaml/',
    ...
    //'loggingdir' => '/var/log/',
    //'datadir' => '/var/data/',
// "loggingdir" => "/exports/nfsdrupal/drupal9/vendor/simplesamlphp/simplesamlphp/logs/",
    "loggingdir" => "/var/www/html/all_drupal/config/simplesamlphp/logs",
    "datadir" => "data/",
    ...
    "technicalcontact_name" => "Arts & Sciences Help",
    "technicalcontact_email" => "artscihelp@wustl.edu",
    ...
    */
    ...
    "secretsalt" => "aa80y3wn671hxcfplah8ufz60ivr750a",
    ...
    "auth.adminpassword" => 'E$a=%=!IyMIzyh476cd65bkj@@946^5)497540',
     ...
     */
    //'trusted.url.domains' => [],
    "trusted.url.domains" => ["artscistage.wustl.edu","anthropology.artscistage.wustl.edu","history.artscistage.wustl.edu","biology.artscistage.wustl.edu","publichealthandsociety.artscistage.wustl.edu","movingstories.artscistage.wustl.edu","myprehealth.artscistage.wustl.edu","olympian.artscistage.wustl.edu",],
    ...
    "store.sql.dsn" => "mysql:host=drupald9-staging.csl8tvdroorh.us-east-2.rds.amazonaws.com;dbname=drupal_prehealth",
    ...
    "store.sql.username" => "drupal_db_user",
    "store.sql.password" => "OHqJP3G(424C8",
