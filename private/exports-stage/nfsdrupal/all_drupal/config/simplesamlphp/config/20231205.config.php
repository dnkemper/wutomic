...
$config = [
  ...
  //'datadir' => '/var/data/',
  "loggingdir" =>
    "/var/www/html/drupal9/vendor/simplesamlphp/simplesamlphp/log/",
  //'loggingdir' => 'log/',
  "datadir" => "data/",
  ...
  //'trusted.url.domains' => [],
  "trusted.url.domains" => [
    "artscistage.wustl.edu",
    "myprehealth.artscidev.wustl.edu",
  ],
  ...
  "session.cookie.samesite" =>
    strpos($userAgent, "Chrome/") === false ? null : "None",
  ...
  "store.sql.dsn" =>
    "mysql:host=drupald9-staging.csl8tvdroorh.us-east-2.rds.amazonaws.com;dbname=drupal_prehealth",
