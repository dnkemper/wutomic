...
$config = [
     ...
     * root directory.
     */
    'loggingdir' => '/var/www/html/drupal9/vendor/simplesamlphp/simplesamlphp/logs/',
    'datadir' => 'data/',
    ...
    */
    ...
    'secretsalt' => 'chr6w31c0nzywdzzzhb2go4ki018s9es',
     ...
     */
    'auth.adminpassword' => '%g$b49kyJYiaJyZzDP*E!c#a%@',
    // Simplesaml gave me a "cannot use hash as pw error while using the pw below
    //'auth.adminpassword' => '$2y$10$TyNSA3UKQMhjGv6.jUZ5g.OiYUGaQEEjXEuLWjUg0AITI6TaMuWw.',
     ...
     */
    //'trusted.url.domains' => [],
    'trusted.url.domains' => ['artscidev.wustl.edu', 'artsci.artscidev.wustl.edu', 'myprehealth.artscidev.wustl.edu'],
...
/*removing as it's causing errors ??  -- chennicke
        45 => [
...
*/
    ...
    'store.sql.dsn'                 => 'mysql:host=drupal-dev-db.cwqu12tw5vjb.us-east-1.rds.amazonaws.com;dbname=drupal_prehealth',
    ...
    'store.sql.password' => 'zJ6rfmYQTJ2f#22',
