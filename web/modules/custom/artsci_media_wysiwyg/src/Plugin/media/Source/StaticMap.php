 ...
 *   forms = {
 *     "media_library_add" = "Drupal\artsci_media_wysiwyg\Form\StaticMapForm",
 *   },
 * )
 */
class StaticMap extends MediaSourceBase {
  ...
  const BASE_URL = 'https://maps.artsci.edu';
  ...
  public function getMetadata(MediaInterface $media, $attribute_name) {
    ...
    $regex = \Drupal::config('artsci_media_wysiwyg.settings')
      ->get('artsci_media_wysiwyg.static_map_regex');
    if ($regex) {
