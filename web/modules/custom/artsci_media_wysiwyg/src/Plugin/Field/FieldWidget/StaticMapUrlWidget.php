...
namespace Drupal\artsci_media_wysiwyg\Plugin\Field\FieldWidget;

use Drupal\Component\Utility\UrlHelper;
use Drupal\Core\Field\FieldItemListInterface;
use Drupal\Core\Form\FormStateInterface;
use Drupal\link\Plugin\Field\FieldWidget\LinkWidget;
use Drupal\artsci_media_wysiwyg\Plugin\Field\FieldType\StaticMapUrl;
use Drupal\artsci_media_wysiwyg\Plugin\media\Source\StaticMap;
...
class StaticMapUrlWidget extends LinkWidget {
  ...
  public static function uriValidation(&$element, $form_state) {
    ...
    $regex = \Drupal::config('artsci_media_wysiwyg.settings')->get('artsci_media_wysiwyg.static_map_regex');
    if ($regex) {
