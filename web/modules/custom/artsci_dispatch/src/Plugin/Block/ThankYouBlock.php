 ...
 *
 * @Block(
 *   id = "artsci_dispatch_thankyou_form",
...
class ThankYouBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    if ($this->configFactory->get('artsci_dispatch.settings')->get('thanks.enabled')) {
      ...
      $build['form'] = $this->formBuilder->getForm('\Drupal\artsci_dispatch\Form\ThankYouForm');
    }
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    ...
    $enabled = $this->configFactory->get('artsci_dispatch.settings')->get('thanks.enabled');
