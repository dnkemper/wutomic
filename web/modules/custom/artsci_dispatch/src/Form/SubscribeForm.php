...
use Drupal\artsci_core\FormHelpersTrait;
...
class SubscribeForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'artsci_dispatch_subscribe_form';
  }
  ...
  protected function getEditableConfigNames() {
    return ['artsci_dispatch.subscribe_form'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $population = NULL) {
    $form['email'] = [
      '#type' => 'email',
      '#title' => $this->t('Email'),
      '#default_value' => $this->config('artsci_dispatch.subscribe_form')->get('email'),
      '#required' => TRUE,
    ];
    $form['first'] = [
      '#type' => 'textfield',
      '#title' => $this->t('First name'),
      '#default_value' => $this->config('artsci_dispatch.subscribe_form')->get('first'),
    ];
    $form['last'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Last name'),
      '#default_value' => $this->config('artsci_dispatch.subscribe_form')->get('last'),
    ];
    $form['population'] = [
      '#type' => 'hidden',
      '#value' => $population,
