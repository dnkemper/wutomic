...
use Drupal\artsci_core\Plugin\Block\RegionContentBlock;
...
class RegionContentBlockTest extends UnitTestCase {
  ...
  public function testBlockBuildReturnsArrayAndDoesNotThrowException() {
    ...
    $config_factory = $this->getConfigFactoryStub([
      'artsci_core.settings' => [
        'artsci_core.region_content.foo' => 3,
      ],
    ]);
    ...
    $sut = new RegionContentBlock($configuration, 'region_content_block', ['provider' => 'artsci_core'], $config_factory, $etm, $route_matcher);
