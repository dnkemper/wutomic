...
use Drupal\artsci_core\Plugin\Filter\FilterIframe;
...
class FilterIframeTest extends UnitTestCase {
   ...
   *
   * @var \Drupal\artsci_core\Plugin\Filter\FilterIframe
   */
  protected $sut;
  ...
  protected function setUp(): void {
    ...
    $this->sut = new FilterIframe($configuration, 'filter_iframe', ['provider' => 'artsci_core']);
