...
namespace Drupal\artsci_core_test\Controller;
  ...
  public function index(Request $request): array {
    ...
    return [
      'banner_test' => [
        ...
        '#template' => "{% include '@atomic_artsci/artsci/banner.html.twig' with banner only %}",
