...
class EventsSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $config = $this->config('artsci_events.settings');

    $form['markup'] = [
      '#type' => 'markup',
      '#markup' => $this->t('<p>These settings let you configure the Artsci Events module.</p>'),
    ];
    ...
    $form['global']['artsci_events_event_link'] = [
      '#type' => 'select',
      '#title' => $this->t('Link Option'),
      '#default_value' => $config->get('event_link'),
      '#description' => $this->t('Choose to have events link to events.artsci.edu or an event page on this site.'),
      '#options' => [
        'event-link-external' => $this->t('Link to events.artsci.edu'),
        'event-link-internal' => $this->t('Link to page on this site'),
      ],
    ];

    $form['global']['artsci_events_single_event_path'] = [
      '#type' => 'textfield',
    ...
    if (isset($config_split) && $config_split->get('status')) {
      ...
      $form['artsci_events_filter']['filter_presenters'] = [
        '#type' => 'checkbox',
      ...
      $form['artsci_events_filter']['filter_attendance_required'] = [
        '#type' => 'checkbox',
      ...
      $form['artsci_events_filter']['filter_attendance_mode'] = [
        '#type' => 'checkbox',
      ...
      $form['artsci_events_filter']['filter_category'] = [
        '#type' => 'checkbox',
