      ...
      switch ($build['#plugin_id']) {
        ...
        case 'menu_block:main':
          ...
          if (in_array('block_menu_horizontal', $selectedStyles)) {
            ...
            $build['#attached']['library'][] = 'atomic_artsci/accessible-menu';
          }
          break;
