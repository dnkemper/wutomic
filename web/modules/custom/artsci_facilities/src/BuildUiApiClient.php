...
class BuildUiApiClient extends ApiClientBase implements BuildUiApiClientInterface {
  ...
  public function __construct(
    ...
    $auth = $this->configFactory->get('artsci_facilities.apis')->get('buildui.auth');
  ...
  public function basePath(): string {
    return $this->configFactory->get('artsci_facilities.apis')->get('buildui.endpoint');
  }
  ...
  protected function getCacheIdBase() {
    return 'artsci_facilities_api_buildui';
  }
