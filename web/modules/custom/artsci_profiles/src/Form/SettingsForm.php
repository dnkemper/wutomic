...
namespace Drupal\artsci_profiles\Form;
...
class SettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'artsci_profiles_settings';
  }
  ...
  protected function getEditableConfigNames() {
    return ['artsci_profiles.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('artsci_profiles.settings');
    ...
    $form['profiles_fieldset'] = [
      ...
      '#suffix' => '</div>',
      '#attached' => [
        'library' => 'artsci_profiles/settings-form',
      ],
    ];
    ...
    foreach ($directories as $key => $directory) {
      ...
      $route = "artsci_profiles.sitemap.{$key}";
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('artsci_profiles.settings')
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    if (isset($directories)) {
      ...
      foreach ($directories as $key => $directory) {
        ...
        if ($url &&
          !str_starts_with($url->getRouteName(), 'artsci_profiles')) {
