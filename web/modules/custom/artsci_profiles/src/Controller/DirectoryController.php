...
namespace Drupal\artsci_profiles\Controller;

use Drupal\Component\Utility\Html;
use Drupal\Core\Breadcrumb\BreadcrumbManager;
use Drupal\Core\Controller\ControllerBase;
use Drupal\Core\Routing\RouteMatchInterface;
use Drupal\artsci_profiles\Client;
...
class DirectoryController extends ControllerBase {
   ...
   *
   * @var \Drupal\artsci_profiles\Client
   */
  protected $profiles;
   ...
   *
   * @param \Drupal\artsci_profiles\Client $profiles
   *   The Profiles service.
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('artsci_profiles.client'),
  ...
  public function build(Request $request, $key, $slug = NULL) {
    $directory = $this->config('artsci_profiles.settings')->get('directories')[$key];

    $build = [
      '#attached' => [
        'library' => [
          "artsci_profiles/client.{$this->profiles->environment}",
          'artsci_profiles/styles',
        ],
        'drupalSettings' => [
          'artsciProfiles' => [
