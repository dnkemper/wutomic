...
namespace Drupal\Tests\artsci_profiles\Functional;
...
class ControllerTest extends BrowserTestBase {
   ...
   * {@inheritdoc}
   */
  protected static $modules = ['artsci_profiles'];
  ...
  protected function setUp(): void {
    ...
    \Drupal::service('module_installer')->install(['artsci_profiles_mock']);
    ...
    $this->config('artsci_profiles.settings')->set('directories', $directories)->save();
