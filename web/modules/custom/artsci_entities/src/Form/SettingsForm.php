...
namespace Drupal\artsci_entities\Form;
...
/**
 * Configure Artsci Area of Study settings for this site.
 */
class SettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'artsci_entities_settings';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['markup'] = [
      '#type' => 'markup',
      '#markup' => $this->t('<p>These settings allows you to customize the display of Artsci Entities on the site.</p>'),
    ];
