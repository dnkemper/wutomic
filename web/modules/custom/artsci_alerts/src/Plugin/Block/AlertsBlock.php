...
namespace Drupal\artsci_alerts\Plugin\Block;
...
class AlertsBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    $config = $this->config->get('artsci_alerts.settings');
  ...
  public function getCacheTags() {
    return Cache::mergeTags(
      parent::getCacheTags(),
      $this->config->get('artsci_alerts.settings')->getCacheTags()
    );
  }
