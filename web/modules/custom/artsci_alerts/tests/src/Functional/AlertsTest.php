...
namespace Drupal\Tests\artsci_alerts\Functional;
...
class AlertsTest extends BrowserTestBase {
  ...
  protected function setUp(): void {
    ...
    $this->drupalPlaceBlock('artsci_alerts_block', [
      'region' => 'alert',
      'id' => 'alertsblock',
      'plugin' => 'artsci_alerts_block',
    ]);
    ...
    $this->adminUser = $this->drupalCreateUser([
      ...
      'administer artsci_alerts configuration',
  ...
  public function testCustomAlert($level) {
    ...
    $this->drupalGet('admin/config/artsci/artsci-alerts');
