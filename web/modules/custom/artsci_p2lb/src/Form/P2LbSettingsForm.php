...
namespace Drupal\artsci_p2lb\Form;
...
use Drupal\artsci_p2lb\P2LbConverterManagerInterface;
...
class P2LbSettingsForm extends ConfigFormBase {
  ...
  /**
   * The artsci_p2lb.converter_manager service.
   *
   * @var \Drupal\artsci_p2lb\P2LbConverterManagerInterface
   */
   ...
   *   The entity_type.manager service.
   * @param \Drupal\artsci_p2lb\P2LbConverterManagerInterface $conversionManager
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      ...
      $container->get('artsci_p2lb.converter_manager'),
    );
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['markup'] = [
      '#type' => 'markup',
      '#markup' => <<< 'EOD'
        <p>These settings let you configure and use Artsci paragraphs2layoutbuilder on this site.</p>
        <p>Additionally, pages can be tracked and converted at <a href="/admin/content/artsci-converter">/admin/content/artsci-converter</a>.</p>
      EOD,
    ];

    // Grab all nodes that currently have paragraphs associated with them.
    $nids_w_paragraphs = artsci_p2lb_paragraph_nodes();
  ...
  public function magicButton(array &$form, FormStateInterface $form_state) {
    ...
    $nids = artsci_p2lb_paragraph_nodes();
