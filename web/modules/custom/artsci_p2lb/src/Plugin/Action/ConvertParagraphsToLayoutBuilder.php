...
namespace Drupal\artsci_p2lb\Plugin\Action;
...
class ConvertParagraphsToLayoutBuilder extends ActionBase {
  ...
  public function execute(?ContentEntityInterface $entity = NULL) {
    /** @var \Drupal\artsci_p2lb\P2LbConverter $converter */
    $converter = \Drupal::service('artsci_p2lb.converter_manager')->createConverter($entity);
    $converter->convert();
  }
