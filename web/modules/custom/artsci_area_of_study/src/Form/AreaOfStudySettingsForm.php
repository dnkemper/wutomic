...
namespace Drupal\artsci_area_of_study\Form;
...
class AreaOfStudySettingsForm extends ConfigFormBase {
   ...
   */
  const SETTINGS = 'artsci_area_of_study.settings';
  ...
  public function getFormId() {
    return 'artsci_area_of_study_settings';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['markup'] = [
      '#type' => 'markup',
      '#markup' => $this->t('<p>These settings let you configure the Artsci Areas of Study feature.</p>'),
    ];
    ...
    $form['global']['areas_of_study_degree_types'] = [
      ...
      '#default_value' => artsci_area_of_study_get_field_label('field_area_of_study_degree_types', 'degree_types'),
      '#required' => TRUE,
    ];
    ...
    $form['global']['areas_of_study_locations'] = [
      ...
      '#default_value' => artsci_area_of_study_get_field_label('field_area_of_study_locations', 'locations'),
      '#required' => TRUE,
    ];
