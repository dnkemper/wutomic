 ...
 * Person Type form.
 *
 * @property \Drupal\artsci_people\PersonTypeInterface $entity
 */
class PersonTypeForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['id'] = [
      ...
      '#machine_name' => [
        'exists' => '\Drupal\artsci_people\Entity\PersonType::load',
      ],
    ...
    $field_settings = $this->configFactory->get('artsci_people.field_settings');
