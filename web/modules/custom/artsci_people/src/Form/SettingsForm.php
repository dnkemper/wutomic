...
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['global']['artsci_people_status'] = [
      '#type' => 'checkbox',
    ...
    $form['global']['artsci_people_title'] = [
      '#type' => 'textfield',
    ...
    $form['global']['artsci_people_path'] = [
      '#type' => 'textfield',
    ...
    $form['global']['artsci_people_research_areas'] = [
      '#type' => 'textfield',
      ...
      '#default_value' => artsci_people_get_research_title(),
      '#required' => TRUE,
    ];

    $form['global']['artsci_people_header_content'] = [
      '#type' => 'text_format',
    ...
    $form['global']['artsci_people_filter']['filter_type'] = [
      '#type' => 'checkbox',
    ...
    $form['global']['artsci_people_sort'] = [
      '#type' => 'select',
      '#title' => $this->t('Sort'),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    // Get values.
    $status = (int) $form_state->getValue('artsci_people_status');
    $title = $form_state->getValue('artsci_people_title');
    $path = $form_state->getValue('artsci_people_path');
    $research_title = $form_state->getValue('artsci_people_research_areas');
    $header_content = $form_state->getValue('artsci_people_header_content');
    $sort = $form_state->getValue('artsci_people_sort');
