...
namespace Drupal\artsci_graph\Plugin\Block;
...
class GraphBlock extends BlockBase {
  ...
  public function build() {
    ...
    $build['graph_container']['#attached']['library'][] = 'artsci_graph/chartjs';
    $build['graph_container']['#attached']['library'][] = 'artsci_graph/graph';
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    ...
    $form['graph_CSV_data'] = [
      ...
      '#description' => $this->t('Copy and paste your properly formatted CSV file here. An example of a properly formatted csv file can be found <a href="https://artsci.artsci.edu/sites/artsci.artsci.edu/files/2021-09/airtravel.csv">here</a>.'),
