...
class AisRfiMiddlewareRemotePostWebformHandler extends AisRfiMiddlewareBaseWebformHandler {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['interaction_uuid'] = [
      ...
      '#description' => $this->t('The middleware interaction UUID. Without this, no data will be sent to the middleware. Contact siddharth-sarathe@artsci.edu for assistance setting up an interaction UUID.'),
    ];
