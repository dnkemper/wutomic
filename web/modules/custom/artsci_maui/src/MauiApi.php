 ...
 * MAUI API service.
 *
 * @see: https://api.maui.artsci.edu/maui/pub/webservices/documentation.page
 */
class MauiApi extends ApiClientBase {
  ...
  public function basePath(): string {
    return 'https://api.maui.artsci.edu/maui/api/';
  }
  ...
  public function getThesisDefenseIds(): array {
    ...
    if ($username && $password) {
      ...
      if ($result === FALSE || !is_array($result)) {
        \Drupal::logger('artsci_maui')->error('Failed to fetch thesis defense IDs.');
        return [];
      }
  ...
  public function getThesisDefenseInfo($university_id): array {
    ...
    if ($username && $password) {
      ...
      if ($result === FALSE || !is_array($result)) {
        \Drupal::logger('artsci_maui')->error('Failed to fetch thesis defense info for university ID: @id', ['@id' => $university_id]);
        return [];
      }
