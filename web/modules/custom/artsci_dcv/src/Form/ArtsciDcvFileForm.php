...
namespace Drupal\artsci_dcv\Form;
 ...
 */
class ArtsciDcvFileForm extends FormBase {
  /**
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $file = $this->entityTypeManager
      ->getStorage('file')
      ->loadByProperties([
        'filename' => $this->state->get('artsci_dcv_filename', ''),
      ]);
  ...
  public function validateForm(&$form, $form_state) {
    ...
    if ($file) {
      $form_state->set('artsci_dcv_filename', $file->getFilename());
    }
    else {
  ...
  public function submitForm(&$form, $form_state) {
    $filename = $form_state->get('artsci_dcv_filename');
    $this->state->set('artsci_dcv_filename', $filename);
