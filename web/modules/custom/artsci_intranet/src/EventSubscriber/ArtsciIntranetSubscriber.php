...
namespace Drupal\artsci_intranet\EventSubscriber;
...
/**
 * Artsci intranet event subscriber.
 */
class ArtsciIntranetSubscriber implements EventSubscriberInterface {
  ...
  /**
   * Constructs a ArtsciIntranetSubscriber.
   *
