...
class HoursApi {
  ...
  const BASE = 'https://hours.iowa.artsci.edu/api/Hours/';

  /**
   * The artsci_hours logger channel.
   *
  ...
  public function __construct(LoggerInterface $logger, CacheBackendInterface $cache, ClientInterface $http_client, ConfigFactoryInterface $configFactory) {
    ...
    $this->group = $configFactory->get('artsci_hours.settings')->get('group');
  }
