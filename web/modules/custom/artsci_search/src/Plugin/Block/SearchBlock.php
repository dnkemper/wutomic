...
namespace Drupal\artsci_search\Plugin\Block;
 ...
 *
 * @Block(
 *   id = "artsci_search_form",
 *   admin_label = @Translation("Artsci Search"),
...
class SearchBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    $build = [];
    if ($this->configFactory->get('artsci_search.settings')->get('artsci_search.display_search')) {
      $build['form'] = $this->formBuilder->getForm('Drupal\artsci_search\Form\SearchForm');
    }
    return $build;
  }
