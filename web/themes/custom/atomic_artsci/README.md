# ARTSCI (Artsci Design System) Base Theme
A Drupal base theme for implementing the Artsci Design System.
...
1. Function arguments are wrapped with single quotes.
    ```twig
    {{ attach_library('atomic_artsci/card-block') }}
    ```
...
5. A comma is present at the end of a list of arguments.
    ```twig
    {% include '@atomic_artsci/artsci/site-parent.html.twig' with {
