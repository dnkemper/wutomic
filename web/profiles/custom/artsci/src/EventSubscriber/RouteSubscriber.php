...
class RouteSubscriber extends RouteSubscriberBase {
  ...
  protected function alterRoutes(RouteCollection $collection) {
    ...
    if ($route = $collection->get('system.403')) {
      $route->setDefault('_controller', '\Drupal\artsci\Controller\Custom403Controller::build');
      $route->setDefault('_title_callback', '\Drupal\artsci\Controller\Custom403Controller::title');
    }
