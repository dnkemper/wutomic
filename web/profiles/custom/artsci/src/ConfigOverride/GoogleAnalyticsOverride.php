...
class GoogleAnalyticsOverride implements ConfigFactoryOverrideInterface {
  ...
  public function loadOverrides($names) {
    ...
    if (in_array('google_analytics.settings', $names)) {
      ...
      // Remove GA based on artsci_core settings.
      $artsci_core_config = $this->configFactory->get('artsci_core.settings');
      if ($artsci_core_config && !$artsci_core_config->get('artsci_core.ga')) {
        $overrides['google_analytics.settings']['account'] = '';
      }
    }
